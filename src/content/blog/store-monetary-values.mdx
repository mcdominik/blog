...
I once worked on a fintech project where monetary values were stored however they wished - as text, decimals, or even floats (scary).
I'll spare you the details of this system, but it still lives in my head and ruins the quality of my sleep.

I spent a lot of time fighting with LLMs that were trying to overengineer a solution to this problem.
I'm writing this to save you time, because the rules are pretty straightforward.
